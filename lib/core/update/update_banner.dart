...
import '../network/skippable_loading.dart';
...
class _UpdateBannerState extends State<UpdateBanner> with SkippableLoading<UpdateBanner> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (_checking) SkipButton(visible: showSkipButton, onSkip: _skipCheck),
